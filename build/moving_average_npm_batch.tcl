...
#
# NOTE:  typical usage would be "vivado -mode tcl -source moving_average_npm_batch.tcl"
#
# STEP#0: define output directory area.
#

set outputDir ./moving_average_build       
file mkdir $outputDir
#
# STEP#1: setup design sources and constraints
#
read_vhdl ../rtl/moving_average.vhd 
...
#
synth_design -top moving_average -part xc7a35tcpg236-1		
